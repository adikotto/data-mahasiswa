...
if (isset($_POST["submit"])) {
   ...
   $primary_nim = mysqli_fetch_assoc($result);
   ...
   if ($nim_error === "" and $nama_error === "" and $tempat_lahir_error === "" and $ipk_error === "") {
      $query = "UPDATE mahasiswa SET nama = '$nama', tempat_lahir = '$tempat_lahir', tanggal_lahir = '$tanggal_lahir', jurusan = '$jurusan', ipk = '$ipk' WHERE nim = '$nim'";
   ...
   $tanggal = substr($tanggal_lahir, 8, 2);
